...
export const BMI_CATEGORIES = {
  UNDERWEIGHT: { label: "Underweight", color: "text-blue-500", bg: "bg-blue-50" },
  NORMAL: { label: "Normal", color: "text-green-600", bg: "bg-green-50" },
  OVERWEIGHT: { label: "Overweight", color: "text-yellow-600", bg: "bg-yellow-50" },
  OBESE: { label: "Obese", color: "text-red-600", bg: "bg-red-50" },
};
