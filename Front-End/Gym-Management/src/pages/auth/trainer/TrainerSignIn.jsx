        ...
        <CardBody className="p-8">
          <div className="text-center mb-8">
            ...
            <Typography variant="small" className="text-gym-text-muted mt-1">
              Manage your classes and members
            </Typography>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Button
              ...
              loading={loading}
              fullWidth
              className="bg-gradient-to-r from-gym-brown to-gym-warm-dark text-white shadow-md hover:shadow-lg transition-all"
            >
          ...
          <Typography variant="small" className="text-center text-gym-text-muted mt-6">
            ...
            <Link to="/auth/trainer/sign-up" className="font-semibold text-gym-brown hover:underline">
              Register
            </Link>
          </Typography>
        </CardBody>
